    ...
    <header className="bg-white/80 backdrop-blur-xl border-b border-gray-100 sticky top-0 z-50 transition-all shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        <div 
          ...
          onClick={() => navigate('/')}
        >
          <span className="font-bold text-3xl text-gray-900 tracking-tight font-display">vivu<span className="text-teal-600">.</span></span>
        </div>
        ...
        <div className="flex items-center gap-4">
          {isAuthenticated ? (
            ...
            <button 
              ...
              className="px-6 py-2.5 rounded-full bg-teal-600 text-white text-sm font-bold tracking-wide transition-all hover:bg-teal-700 hover:scale-105 active:scale-95 shadow-sm"
            >
              Đăng nhập
            </button>
          )}
